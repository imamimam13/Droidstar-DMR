...

{
  ...
  // Q_PROPERTY(QString m_firstName READ getFirstName WRITE setFirstName NOTIFY
  // firstNameChanged) Q_PROPERTY(QString m_firstName READ firstName WRITE
  // setFirstName NOTIFY firstNameChanged)
...
public:
  ...
  void set_dmr_params(uint8_t essid, QString password, QString lat, QString lon,
                      QString location, QString desc, QString freq, QString url,
